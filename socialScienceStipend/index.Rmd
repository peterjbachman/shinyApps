---
title: "Social Science Stipends"
author: 
  - name: Peter Bachman - @[peterjbachman](https://twitter.com/peterjbachman)
    affiliation: Washington Univerity in St. Louis
...
Inspiration for this comes from the Biology PhD. Stipends 2022 Shiny App ([link](https://rhettrautsaw.app/shiny/BiologyPhDStipends/)).
...
function. The `selectInput` and `sliderInput` functions create the input widgets
